...
*(Recommended to use in situations where multiple groups of conversation/sounds are happening concurrently.)* <br />
...
*(Recommended to use in situations where important speech is delivered.)* <br />
...
*(Recommended to use in situations where character speech and environment sounds/background music are concurrent.)* <br />
...
*(Recommended to use for any sound, especially sounds on the lower/higher registry.)* <br />
...
*(Recommended to use for character/system speech that contains important information.)* <br />
...
*(Recommended to use in situations where the directional location of a sound-producing object is important to the experience.)* <br />
...
*(Recommended to use in situations where user is needs to locate sound source inside a small, reachable environment)* <br />
...
*(Recommended to use before important sound message is played.)* <br />
...
*(Recommended to use when there are feedback sounds in the program.)* <br />
